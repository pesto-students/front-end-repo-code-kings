...
//     navigate('/profile') // Please sync "edit profilepage" to the project
//   }, [])
...
//   )
// }
// absolute top-[-253px] left-[307px] box-border w-[638px] h-0.5 border-t-[2px] border-solid border-gray-500 //
...
const ProfileForm = () => {
  ...
  return (
    <div className="absolute top-[90px] left-[1100px] w-full max-w-xs">
      <form
      ...
      >
        ...
        <div className="mb-4 flex items-start">
          <label
            className="block text-gray-700 text-sm font-bold mb-2 mr-3 pt-2"
            htmlFor="bio"
          >
            Bio
          </label>
        ...
        <div className="mb-6 flex item-start">
          <label
            className="block text-gray-700 text-sm font-bold mr-2 pt-2 mb-2"
            htmlFor="birthday"
          >
            Birthday
          </label>
        ...
        <div className="flex items-center justify-between">
          <button
            className="absolute top-[315px] left-[100px] w-[120px] h-[30px] bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-1 focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Save
          </button>
